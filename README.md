...
| **Ops** | 521MB image, non-root uid; horizontally scalable — no retrieval state in process memory; ~510 rps cached at 40,079 chunks (n=5, ±10%), p95 flat under a cold query |
